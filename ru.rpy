...
######## Cena Avião
        ...
        airplane_notify_1 = "{b}{color=#33b77a} João{/color}{/b} se preocupa com você"
        ...
        airplane_notify_2 = "{b}{color=#33b77a} João{/color}{/b} notou seus ciúmes"
